...
<tr data-index="${globalIdx}" class="border-b border-gray-200 hover:bg-gray-50">
    <td class="px-2 py-1.5">
        <input type="text" class="editor-sys-field border border-gray-300 p-1 text-xs w-32"
            value="${escHtml(sys.label || '')}" data-node-idx="${globalIdx}" data-field="label" placeholder="System label">
    </td>
    <td class="px-2 py-1.5">
        <input type="text" class="editor-sys-field border border-gray-300 p-1 text-xs w-28"
            value="${escHtml(sys.vendor || '')}" data-node-idx="${globalIdx}" data-field="vendor" placeholder="Vendor">
    </td>
    <td class="px-2 py-1.5">
        <input type="number" class="editor-sys-field border border-gray-300 p-1 text-xs w-20"
            value="${escHtml(sys.users != null ? sys.users : '')}" data-node-idx="${globalIdx}" data-field="users" placeholder="0" min="0">
    </td>
    <td class="px-2 py-1.5">
        <input type="number" class="editor-sys-field border border-gray-300 p-1 text-xs w-24"
            value="${escHtml(sys.annualCost != null ? sys.annualCost : '')}" data-node-idx="${globalIdx}" data-field="annualCost" placeholder="0" min="0">
    </td>
    <td class="px-2 py-1.5">
        <select class="editor-sys-field border border-gray-300 p-1 text-xs" data-node-idx="${globalIdx}" data-field="portability">
            <option value="">--</option>
            ${portSel}
        </select>
    </td>
    <td class="px-2 py-1.5">
        <select class="editor-sys-field border border-gray-300 p-1 text-xs" data-node-idx="${globalIdx}" data-field="isCloud">
            <option value="">--</option>
            <option value="true"${sys.isCloud === true ? ' selected' : ''}>Yes</option>
            <option value="false"${sys.isCloud === false ? ' selected' : ''}>No</option>
        </select>
    </td>
    <td class="px-2 py-1.5">
        <select class="editor-sys-field border border-gray-300 p-1 text-xs" data-node-idx="${globalIdx}" data-field="supportModel">
            <option value="">--</option>
            ${supportSel}
        </select>
    </td>
...
<div>
    <div class="overflow-x-auto">
        <table class="w-full text-xs border border-gray-200" id="sysTable">
            <thead class="bg-gray-100 text-left">
                <tr>
...
export function wirePreImportEditor(json, onImport, onBack) {
    ...
    function rerenderSystems() {
        ...
        updateTabCounts();
        // Also re-render dependencies since system options may have changed
