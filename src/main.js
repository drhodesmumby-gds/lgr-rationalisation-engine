...
// --- Warn before leaving page if there's meaningful state ---
window.addEventListener('beforeunload', (e) => {
    const hasWork = state.rawUploads.length > 0 || state.simulationState;
    if (hasWork) {
        e.preventDefault();
    }
});
...
document.getElementById('btnLoadDemo').addEventListener('click', () => {
    const demoDataA = {
        ...
        nodes: [
            ...
            { id: "sys-sap-erp", label: "SAP S/4HANA ERP", type: "ITSystem", vendor: "SAP", users: 5000, annualCost: 2100000, endYear: 2030, endMonth: 3, noticePeriod: 18, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: true, supportModel: "vendor-supported", capabilityType: ["payments", "workflow"], version: "S/4HANA 2023", notes: "Monolithic ERP — underpins finance, HR, and procurement. 18-month notice period means decision needed early. On-prem hosting at County Hall DC." },
            { id: "sys-liquidlogic", label: "Liquidlogic LAS", type: "ITSystem", vendor: "System C", users: 1200, annualCost: 480000, endYear: 2028, endMonth: 9, noticePeriod: 6, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported", version: "v14.2", notes: "Good data portability via SSDA903 exports. Consider early engagement with System C about multi-authority licensing." },
            { id: "sys-confirm-highways", label: "Confirm Highways", type: "ITSystem", vendor: "Confirm", users: 400, annualCost: 320000, endYear: 2029, endMonth: 6, noticePeriod: 6, portability: "Medium", dataPartitioning: "Segmented", hosting: "on-premise", isERP: false, supportModel: "vendor-supported", sharedWith: ["District Council 1"], version: "v22.10", notes: "Shared instance with District 1 — both councils contribute asset data. GIS integration with ESRI." },
            { id: "sys-public-health-intel", label: "Public Health Intelligence", type: "ITSystem", vendor: "In-House", users: 80, annualCost: 35000, endYear: 2030, endMonth: 12, noticePeriod: 3, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "community-supported", sharedWith: ["Other County Programme Council A", "Other County Programme Council B"], version: "v2.1", notes: "Developed in-house by county digital team. Python/Django stack. Two other programme councils contribute data and co-fund development." },
            { id: "sys-nec-revenues", label: "NEC Revenues", type: "ITSystem", vendor: "NEC", users: 300, annualCost: 190000, endYear: 2026, endMonth: 6, noticePeriod: 12, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "vendor-supported", version: "NEC iWorld 2019", notes: "Contract expires before vesting date — must either extend or migrate. Notice period means decision needed imminently." },
            { id: "sys-capita-one", label: "Capita ONE", type: "ITSystem", vendor: "Capita", users: 800, annualCost: 350000, endYear: 2028, endMonth: 12, noticePeriod: 6, portability: "Medium", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported", version: "v22.3", notes: "Critical for children's services statutory returns. ADCS data standards compliance." }
        ],
        edges: [
    ...
    const demoDataB = {
        ...
        nodes: [
            ...
            { id: "fn-109", label: "Highway Maintenance", type: "Function", lgaFunctionId: "109" },
            { id: "sys-civica-fin", label: "Civica Financials", type: "ITSystem", vendor: "Civica", users: 120, annualCost: 95000, endYear: 2028, endMonth: 6, noticePeriod: 6, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported", version: "Civica Cx 2024", notes: "Recently upgraded from legacy Authority system. Clean data model." },
            { id: "sys-nec-revben", label: "NEC Revenues & Benefits", type: "ITSystem", vendor: "NEC", users: 200, annualCost: 180000, endYear: 2027, endMonth: 3, noticePeriod: 9, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "vendor-supported", sharedWith: ["District Council 2"], version: "NEC iWorld 2019", notes: "Shared instance with District 2. Contract held by District 1. Monolithic data — disaggregation would require NEC professional services." },
            { id: "sys-idox-uniform", label: "Idox Uniform", type: "ITSystem", vendor: "Idox", users: 35, annualCost: 55000, endYear: 2029, endMonth: 3, noticePeriod: 3, portability: "Medium", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-bartec-waste", label: "Bartec Waste Management", type: "ITSystem", vendor: "Bartec", users: 90, annualCost: 130000, endYear: 2029, endMonth: 6, noticePeriod: 6, portability: "Medium", dataPartitioning: "Segmented", hosting: "on-premise", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-dynamics-crm", label: "Microsoft Dynamics 365", type: "ITSystem", vendor: "Microsoft", users: 350, annualCost: 110000, endYear: 2030, endMonth: 9, noticePeriod: 3, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported", capabilityType: ["forms"] },
            { id: "sys-confirm-highways-d1", label: "Confirm Highways", type: "ITSystem", vendor: "Confirm", users: 45, annualCost: 95000, endYear: 2029, endMonth: 6, noticePeriod: 6, portability: "Medium", dataPartitioning: "Segmented", hosting: "partner-hosted", hostingPartner: "County Council", isERP: false, supportModel: "vendor-supported", sharedWith: ["County Council"] }
        ],
        edges: [
    ...
    const demoDataC = {
        ...
        nodes: [
            ...
            { id: "fn-38", label: "Waste Management", type: "Function", lgaFunctionId: "38" },
            { id: "fn-43", label: "Accessing Information", type: "Function", lgaFunctionId: "43" },
            { id: "sys-nec-revben-d2", label: "NEC Revenues & Benefits", type: "ITSystem", vendor: "NEC", users: 150, annualCost: 160000, endYear: 2027, endMonth: 3, noticePeriod: 9, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "vendor-supported", sharedWith: ["District Council 1"] },
            { id: "sys-nec-housing", label: "NEC Housing", type: "ITSystem", vendor: "NEC", users: 100, annualCost: 140000, endYear: 2028, endMonth: 12, noticePeriod: 6, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-nec-planning", label: "NEC Planning", type: "ITSystem", vendor: "NEC", users: 28, annualCost: 60000, endYear: 2029, endMonth: 9, noticePeriod: 6, portability: "Medium", dataPartitioning: "Segmented", hosting: "on-premise", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-whitespace-waste", label: "Whitespace Waste", type: "ITSystem", vendor: "Whitespace", users: 60, annualCost: 85000, endYear: 2028, endMonth: 3, noticePeriod: 3, portability: "Medium", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-firmstep-crm", label: "Firmstep Digital", type: "ITSystem", vendor: "Firmstep", users: 200, annualCost: 75000, endYear: 2030, endMonth: 6, noticePeriod: 3, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported" }
        ],
        edges: [
    ...
    const demoDataD = {
        ...
        nodes: [
            ...
            { id: "sys-sage-finance", label: "Sage 50 Finance", type: "ITSystem", vendor: "Sage", users: 25, annualCost: 15000, endYear: 2026, endMonth: 3, noticePeriod: 6, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "unsupported" },
            { id: "sys-inhouse-planning", label: "In-House Planning Register", type: "ITSystem", vendor: "In-House", users: 15, annualCost: 12000, endYear: 2027, endMonth: 6, noticePeriod: 3, portability: "Medium", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "unsupported" },
            { id: "sys-inhouse-waste", label: "In-House Waste Scheduling", type: "ITSystem", vendor: "In-House", users: 20, annualCost: 8000, endYear: 2028, endMonth: 9, noticePeriod: 3, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "unsupported" },
            { id: "sys-nec-housing-d3", label: "NEC Housing", type: "ITSystem", vendor: "NEC", users: 60, annualCost: 90000, endYear: 2029, endMonth: 3, noticePeriod: 6, portability: "Low", dataPartitioning: "Monolithic", hosting: "on-premise", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-goss-icm", label: "GOSS iCM", type: "ITSystem", vendor: "GOSS", users: 100, annualCost: 40000, endYear: 2030, endMonth: 12, noticePeriod: 3, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "vendor-supported" },
            { id: "sys-koha-library", label: "Koha Library System", type: "ITSystem", vendor: "In-House", users: 30, annualCost: 18000, endYear: 2030, endMonth: 9, noticePeriod: 3, portability: "High", dataPartitioning: "Segmented", hosting: "cloud", isERP: false, supportModel: "community-supported", sharedWith: ["Neighbouring Council A", "Neighbouring Council B"] }
        ],
        edges: [
